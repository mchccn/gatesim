        ...
        if (expr.startsWith("(") && expr.endsWith(")")) {
            ...
            product.forEach((o, j) => {
                ...
                const sumGate = {
                    ...
                    type: "COMPONENT",
                    name: "OR",
                    inputs: sum.map((v) => (0,_variables__WEBPACK_IMPORTED_MODULE_1__.isInversion)(v)
                    ...
                    outputs: [
                        sum.some((v) => (0,_variables__WEBPACK_IMPORTED_MODULE_1__.isInversion)(v))
                            ? { id: id.next().value, activated: true }
                ...
                sum.forEach((v) => {
                    if ((0,_variables__WEBPACK_IMPORTED_MODULE_1__.isInversion)(v)) {
                        // reference Input
                        inputs[(0,_variables__WEBPACK_IMPORTED_MODULE_1__.fromVariable)(v)];
                    }
                });
            });
            return;
...
try {
    ...
    self.postMessage({
        code: "FINISHED",
        message: JSON.stringify((0,_algebra_reify__WEBPACK_IMPORTED_MODULE_0__.reify)(table[0][0].length, (0,_algebra_stringify__WEBPACK_IMPORTED_MODULE_1__.stringify)(table))),
    });
}
catch (e) {
