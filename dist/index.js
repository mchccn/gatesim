...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constants */ "./src/constants.ts");
/* harmony import */ var _keybinds__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./keybinds */ "./src/keybinds.ts");
...
/* harmony import */ var _premade__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./premade */ "./src/premade/index.ts");
/* harmony import */ var _styles__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./styles */ "./src/styles.ts");
...
await (0,_styles__WEBPACK_IMPORTED_MODULE_6__.loadStyles)();
const shouldLoadPremade = new URL(location.href).searchParams.get("premade");
if (shouldLoadPremade && _premade__WEBPACK_IMPORTED_MODULE_5__.premade.has(shouldLoadPremade.trim().toLowerCase())) {
    _premade__WEBPACK_IMPORTED_MODULE_5__.premade.get(shouldLoadPremade.trim().toLowerCase())();
}
else {
    _managers_SandboxManager__WEBPACK_IMPORTED_MODULE_2__.SandboxManager.setup({ keybinds: _keybinds__WEBPACK_IMPORTED_MODULE_1__.keybinds, menu: _menu__WEBPACK_IMPORTED_MODULE_4__.menu, save: "sandbox" });
    ...
    static setup(config) {
        ...
        this.#observer = new MutationObserver(() => {
            if (Date.now() - lastChecked > 25) {
                ...
                const check = this.#config.checkState?.(_reified_Reified__WEBPACK_IMPORTED_MODULE_6__.Reified.active.clone(), _WiringManager__WEBPACK_IMPORTED_MODULE_13__.WiringManager.wires.clone()) ?? false;
                if (check)
...
/* harmony import */ var _Reified__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Reified */ "./src/reified/Reified.ts");
...
class Component extends _Reified__WEBPACK_IMPORTED_MODULE_5__.Reified {
    element;
    inputs;
    outputs;
    name;
    ...
    constructor(chip, pos) {
        super();
        this.chip = chip;
        this.element = _Reified__WEBPACK_IMPORTED_MODULE_5__.html `
            <div class="component">
                        ...
                        "delete-connections": {
                            ...
                            callback: () => {
                                ...
                                return _managers_SandboxManager__WEBPACK_IMPORTED_MODULE_2__.SandboxManager.pushHistory(() => {
                                    ...
                                    _managers_WiringManager__WEBPACK_IMPORTED_MODULE_4__.WiringManager.wires.addAll(deleted.splice(0, deleted.length).map((from) => new _managers_WiringManager__WEBPACK_IMPORTED_MODULE_4__.Wiring(from, input)));
                                });
                            },
                        },
                    },
                ...
                _managers_SandboxManager__WEBPACK_IMPORTED_MODULE_2__.SandboxManager.queueNewContext((prev) => [
                    {
                        "create-connection": {
                            ...
                            callback: () => {
                                _managers_WiringManager__WEBPACK_IMPORTED_MODULE_4__.NewWireContext.from = output;
                            },
                        },
                        "delete-connections": {
                            label: "Delete connections",
                            callback: () => {
                                ...
                                return _managers_SandboxManager__WEBPACK_IMPORTED_MODULE_2__.SandboxManager.pushHistory(() => {
                                    ...
                                    _managers_WiringManager__WEBPACK_IMPORTED_MODULE_4__.WiringManager.wires.addAll(deleted.splice(0, deleted.length).map((to) => new _managers_WiringManager__WEBPACK_IMPORTED_MODULE_4__.Wiring(output, to)));
                                });
                            },
                        },
                    },
            ...
            _managers_SandboxManager__WEBPACK_IMPORTED_MODULE_2__.SandboxManager.queueNewContext((prev) => [
                {
                    "delete-component": {
                        ...
                        callback: () => {
                            if (this.PERMANENT)
                                return void _managers_ToastManager__WEBPACK_IMPORTED_MODULE_3__.ToastManager.toast({
                            ...
                            const deleted = [];
                            return _managers_SandboxManager__WEBPACK_IMPORTED_MODULE_2__.SandboxManager.pushHistory(() => {
                                _Reified__WEBPACK_IMPORTED_MODULE_5__.Reified.active["delete"](this);
                                this.detach();
                                _managers_WiringManager__WEBPACK_IMPORTED_MODULE_4__.WiringManager.wires.forEach((wire) => {
                                ...
                                _Reified__WEBPACK_IMPORTED_MODULE_5__.Reified.active.add(this);
                                this.attach();
...
class Input extends _Reified__WEBPACK_IMPORTED_MODULE_5__.Reified {
    element;
    constructor(pos = { x: 0, y: 0 }) {
        super();
        this.element = _Reified__WEBPACK_IMPORTED_MODULE_5__.html `<button class="board-input">I</button>`;
        this.move(pos);
    }
    #mouseup = () => {
        this.element.blur();
        ...
        _managers_SandboxManager__WEBPACK_IMPORTED_MODULE_2__.SandboxManager.queueNewContext((prev) => [
            {
                "create-connection": {
                    label: "Create connection",
                    callback: () => {
                        _managers_WiringManager__WEBPACK_IMPORTED_MODULE_4__.NewWireContext.from = this.element;
                    },
                },
                "delete-input": {
                    label: "Delete input",
                    callback: () => {
                        ...
                        return _managers_SandboxManager__WEBPACK_IMPORTED_MODULE_2__.SandboxManager.pushHistory(() => {
                            ...
                            _Reified__WEBPACK_IMPORTED_MODULE_5__.Reified.active.add(this);
                            this.attach();
                            _managers_WiringManager__WEBPACK_IMPORTED_MODULE_4__.WiringManager.wires.addAll(deleted.splice(0, deleted.length).map((to) => new _managers_WiringManager__WEBPACK_IMPORTED_MODULE_4__.Wiring(this.element, to)));
                        });
                    },
                },
                "delete-connections": {
...
class Output extends _Reified__WEBPACK_IMPORTED_MODULE_5__.Reified {
    element;
    #mouseup = () => {
        this.element.blur();
    };
                ...
                "delete-output": {
                    ...
                    callback: () => {
                        ...
                        return _managers_SandboxManager__WEBPACK_IMPORTED_MODULE_2__.SandboxManager.pushHistory(() => {
                            ...
                            _Reified__WEBPACK_IMPORTED_MODULE_5__.Reified.active.add(this);
                            this.attach();
                            _managers_WiringManager__WEBPACK_IMPORTED_MODULE_4__.WiringManager.wires.addAll(deleted.splice(0, deleted.length).map((from) => new _managers_WiringManager__WEBPACK_IMPORTED_MODULE_4__.Wiring(from, this.element)));
                        });
                    },
                },
                "delete-connections": {
    ...
    constructor(pos = { x: 0, y: 0 }) {
        super();
        this.element = _Reified__WEBPACK_IMPORTED_MODULE_5__.html `<button class="board-output">O</button>`;
        this.move(pos);
    }
    attach() {
        super.attach();
