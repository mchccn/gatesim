...
class SettingsManager {
    ...
    static #listener = async () => {
        ...
        `;
        await _ModalManager__WEBPACK_IMPORTED_MODULE_3__.ModalManager.popup(form);
