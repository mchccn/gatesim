...
table.addEventListener("input", () => {
    const heuristics = (0,_table__WEBPACK_IMPORTED_MODULE_3__.validTable)(table.value);
});
...
function validTable(string) {
    ...
    if (parts.length > 2)
        heuristics.push({ row: 1, message: "more than two columns" });
    return heuristics;
}
