...
/* harmony import */ var _ToastManager__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./ToastManager */ "./src/managers/ToastManager.ts");
/* harmony import */ var _WiringManager__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./WiringManager */ "./src/managers/WiringManager.ts");
...
class SelectionManager {
    ...
    static #copy = async (e) => {
        if (this.selected.size) {
            ...
            const data = (0,_files__WEBPACK_IMPORTED_MODULE_2__.saveDiagram)(array, [..._WiringManager__WEBPACK_IMPORTED_MODULE_10__.WiringManager.wires].filter((wiring) => array.some((component) => {
    ...
    static #paste = async () => {
        ...
        if (error)
            return _ToastManager__WEBPACK_IMPORTED_MODULE_9__.ToastManager.toast({
                message: "Unable to paste diagram data.",
                color: _constants__WEBPACK_IMPORTED_MODULE_1__.ACTIVATED_CSS_COLOR,
                duration: 2500,
            });
        const mouse = { ..._MouseManager__WEBPACK_IMPORTED_MODULE_7__.MouseManager.mouse };
        _SandboxManager__WEBPACK_IMPORTED_MODULE_8__.SandboxManager.pushHistory(() => {
            ...
            if (components.every((component) => _reified_Reified__WEBPACK_IMPORTED_MODULE_6__.Reified.active.has(component))) {
                ...
                if (_MouseManager__WEBPACK_IMPORTED_MODULE_7__.MouseManager.mouse.x !== -1 && _MouseManager__WEBPACK_IMPORTED_MODULE_7__.MouseManager.mouse.y !== -1) {
                ...
                _WiringManager__WEBPACK_IMPORTED_MODULE_10__.WiringManager.wires.addAll(wirings);
            }
        }, () => {
            ...
            _WiringManager__WEBPACK_IMPORTED_MODULE_10__.WiringManager.wires.deleteAll(wirings);
        });
    };
