...
/* harmony import */ var _StorageManager__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./StorageManager */ "./src/managers/StorageManager.ts");
...
class SandboxManager {
    ...
    static setup(config) {
        ...
        _WiringManager__WEBPACK_IMPORTED_MODULE_14__.WiringManager.start();
        const createReifiedActive = (components) => new _augments_WatchedSet__WEBPACK_IMPORTED_MODULE_0__.WatchedSet()
            ...
            if (totals.chipsTotal + totals.inputsTotal + totals.outputsTotal >
                ...
                _ToastManager__WEBPACK_IMPORTED_MODULE_13__.ToastManager.toast({
        ...
        if (typeof this.#config.initial !== "undefined") {
            ...
            _WiringManager__WEBPACK_IMPORTED_MODULE_14__.WiringManager.wires = createWiringsSet(this.#config.initial[1]);
        }
        if (typeof this.#config.save !== "undefined") {
            const file = _StorageManager__WEBPACK_IMPORTED_MODULE_12__.StorageManager.get("saves:" + this.#config.save);
            if (file) {
                const { error, result: [components, wires], } = (0,_files__WEBPACK_IMPORTED_MODULE_2__.fromFile)(file);
                if (error) {
                    _StorageManager__WEBPACK_IMPORTED_MODULE_12__.StorageManager["delete"]("saves:" + this.#config.save);
                    _ToastManager__WEBPACK_IMPORTED_MODULE_13__.ToastManager.toast({
                    ...
                    if (!this.#config.overrideSaveIfExists) {
                        ...
                        _reified_Reified__WEBPACK_IMPORTED_MODULE_6__.Reified.active.forEach((component) => component.attach());
                        _WiringManager__WEBPACK_IMPORTED_MODULE_14__.WiringManager.wires = createWiringsSet(wires);
                    }
                    _StorageManager__WEBPACK_IMPORTED_MODULE_12__.StorageManager.set("saves:" + this.#config.save, (0,_files__WEBPACK_IMPORTED_MODULE_2__.saveDiagram)([..._reified_Reified__WEBPACK_IMPORTED_MODULE_6__.Reified.active], [..._WiringManager__WEBPACK_IMPORTED_MODULE_14__.WiringManager.wires]));
                }
            }
        }
        ...
        this.#interval = setInterval(() => {
            const check = this.#config.checkState?.(_reified_Reified__WEBPACK_IMPORTED_MODULE_6__.Reified.active.clone(), _WiringManager__WEBPACK_IMPORTED_MODULE_14__.WiringManager.wires.clone()) ?? false;
            if (check)
    ...
    static reset() {
        ...
        _WiringManager__WEBPACK_IMPORTED_MODULE_14__.WiringManager.stop();
    ...
    static clear() {
        ...
        _WiringManager__WEBPACK_IMPORTED_MODULE_14__.WiringManager.wires.forEach((wire) => wire.destroy());
    }
    ...
    static popHistory() {
        if (!this.#history.length)
            return void _ToastManager__WEBPACK_IMPORTED_MODULE_13__.ToastManager.toast({
    ...
    static async saveTo(save) {
        ...
        if (_StorageManager__WEBPACK_IMPORTED_MODULE_12__.StorageManager.has("saves:" + this.#config.save) &&
