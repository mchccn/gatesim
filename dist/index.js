...
class SandboxManager {
    ...
    static applySettings(settings) {
        _DraggingManager__WEBPACK_IMPORTED_MODULE_8__.DraggingManager.snapToGrid = settings.snapToGrid ?? false;
    }
    static applyRawSettings(settings) {
        _DraggingManager__WEBPACK_IMPORTED_MODULE_8__.DraggingManager.snapToGrid = settings["DraggingManager.snapToGrid"];
    }
