...
/* harmony export */ });
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../constants */ "./src/constants.ts");
/* harmony import */ var _managers_StorageManager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../managers/StorageManager */ "./src/managers/StorageManager.ts");
...
class TruthTable extends HTMLElement {
    ...
    constructor() {
        super();
        this.appendChild(_reified_Reified__WEBPACK_IMPORTED_MODULE_3__.html `
        ...
        setTimeout(() => {
            if (!_managers_StorageManager__WEBPACK_IMPORTED_MODULE_1__.StorageManager.has("cad:input"))
                _managers_StorageManager__WEBPACK_IMPORTED_MODULE_1__.StorageManager.set("cad:input", "");
            this.#input.value = _managers_StorageManager__WEBPACK_IMPORTED_MODULE_1__.StorageManager.get("cad:input");
            this.#highlightInput();
            this.#syncSizes();
            ...
            this.#input.addEventListener("paste", async (e) => {
                ...
                if (/[^01: ]/.test(text)) {
                    e.preventDefault();
                    return _managers_ToastManager__WEBPACK_IMPORTED_MODULE_2__.ToastManager.toast({
            ...
            this.#input.addEventListener("input", () => {
                ...
                _managers_StorageManager__WEBPACK_IMPORTED_MODULE_1__.StorageManager.set("cad:input", this.#value);
                this.#highlightInput();
                this.#syncSizes();
            });
...
/* harmony import */ var _TruthTable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./TruthTable */ "./src/cad/TruthTable.ts");
